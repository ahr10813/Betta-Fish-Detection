...
public class MidAct1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mid_act1);
        ...
        if (tv2.getText().toString().equalsIgnoreCase("9 VEILTAIL")) {
            ...
            tv1.setText("Veiltail Female");
        }

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MidAct1.this, ClassMale1.class);
                startActivity(i);
            }
        });
