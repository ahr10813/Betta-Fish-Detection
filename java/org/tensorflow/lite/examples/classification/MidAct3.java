...
public class MidAct3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mid_act3);
        ...
        String str = intent.getStringExtra("message3");
        tv2.setText(str);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MidAct3.this, ClassMale3.class);
                startActivity(i);
            }
        });
