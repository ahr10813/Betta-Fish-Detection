...
public class MidAct4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mid_act4);
        ...
        String str = intent.getStringExtra("message4");
        tv2.setText(str);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MidAct4.this, ClassMale4.class);
                startActivity(i);
            }
        });
