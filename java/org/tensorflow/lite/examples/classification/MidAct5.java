...
public class MidAct5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mid_act5);
        ...
        String str = intent.getStringExtra("message5");
        tv2.setText(str);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MidAct5.this, ClassMale5.class);
                startActivity(i);
            }
        });
